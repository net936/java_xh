      ...
      >
        <div>
          <a-form ref="myform" :label-col="{ style: { width: '80px' } }" :model="modal.form" :rules="modal.rules">
            <a-row :gutter="24">
              <a-col span="24">
                <a-form-item label="鲜花名称" name="title">
              ...
              <a-col span="12">
                <a-form-item label="颜色">
                  <a-input placeholder="请输入" v-model:value="modal.form.yanse" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="包装">
                  <a-input placeholder="请输入" v-model:value="modal.form.baozhuang" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="枝数" name="zhishu">
                  <a-input-number placeholder="请输入" :min="1" v-model:value="modal.form.zhishu" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
...
<script setup>
  ...
  const modal = reactive({
    ...
    rules: {
      ...
      zhishu: [{ required: true, message: '请输入枝数', trigger: 'change' }],
  ...
  const handleOk = () => {
    myform.value
      ...
      .then(() => {
        ...
        formData.append('yanse', modal.form.yanse || '');
        formData.append('baozhuang', modal.form.baozhuang || '');
        formData.append('zhishu', modal.form.zhishu || '');
